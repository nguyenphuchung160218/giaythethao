    ...
    <body>
        ...
        <div class="modal fade" id="productview" tabindex="-1" role="dialog" aria-labelledby="productview-title" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content rounded shadow border-0">
                    <div class="modal-header">
                        <h5 class="modal-title" id="productview-title">{{ isset($viewProduct) ? $viewProduct : 'Giày' }} </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="slider slider-for">
                                        ...
                                        <div><img src="images/shop/product/single-2.jpg" class="img-fluid rounded" alt=""></div>
                                    ...
                                    <div class="slider slider-nav">
                                        ...
                                        <div><img src="images/shop/product/single-2.jpg" class="img-fluid" alt=""></div>
